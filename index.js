...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.cgv1zq7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.get("/", (req, res) => {
  res.send("Hello from PocketCash Server...");
});

app.listen(port, () => {
  console.log(`PocketCash is running on port ${port}`);
});